...
async def agent(mcp_server):
    """Creates an instance of the SimplifiedPowerSystemAgent."""
    # This agent needs the mcp_server fixture
    return SimplifiedPowerSystemAgent(mcp_server=mcp_server, session=None)
